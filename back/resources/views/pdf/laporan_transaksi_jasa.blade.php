        ...
        <page_header>
            ...
            <table class="page_header">
                <tr>
                    ...
                    <td style="text-align: center; width: 60%">LAPORAN DATA TRANSAKSI JASA</td>
        ...
        <table class="tabel2">
            <thead>
                <tr>
                    ...
                    <td style="text-align: center; background: #ddd"><b>Nama Jasa</b></td>
                    <td style="text-align: center; background: #ddd"><b>Tanggal Transaksi</b></td>
                    <td style="text-align: center; background: #ddd"><b>Total Transaksi Jasa</b></td>
                    <td style="text-align: center; background: #ddd"><b>Nama Kasir</b></td>
                </tr>
            </thead>
            <tbody> 
                {{-- 'NO', 'Kode Transaksi', 'Nama Jasa','Tanggal Transaksi', 'Total Transaksi Jasa','Nama Kasir', --}}
                <?php $i = 1; ?>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td style="text-align: center; width:150px;">
                              {{ $item->kode_transaksi_jasa }}
                        </td>
                        <td style="text-align: center; width:150px;">
                              {{ $item->jasa->nama_jasa }}
                        </td>
                        <td style="text-align: center; width:150px;">
                              {{ date('d-M-Y', strtotime($item->tanggal_transaksi_jasa)) }}
                        </td>
                        <td style="text-align: center; width:150px;">
                              @currency($item->total_harga_jasa)
                        </td>
