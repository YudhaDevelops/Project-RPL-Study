        ...
        <page_header>
            ...
            <table class="page_header">
                <tr>
                    ...
                    <td style="text-align: center; width: 60%">LAPORAN DATA PRODUK</td>
        ...
        <table>
            <tr>
                ...
                <td align="center" style="width: 770px;">
                    ...
                    <br><br>
                    Supply & Service Hewan Kesayangan |<br> Jual Produk Makanan Anjing & Kucing - Grooming Anjing &
                    Kucing
                    <br><br>
        ...
        <table class="tabel2">
            <thead>
                <tr>
                    ...
                    <td style="text-align: center; background: #ddd"><b>Bobot / gram</b></td>
                    <td style="text-align: center; background: #ddd"><b>Harga / Rp.</b></td>
                    <td style="text-align: center; background: #ddd"><b>Stok</b></td>
                    <td style="text-align: center; background: #ddd"><b>Gambar Produk</b></td>
                </tr>
            </thead>
            <tbody>
                <?php $i = 1; ?>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td style="text-align: center; width:95px;">
                            <img src="{{ $item->gambar_produk }}" style="max-width: 150px;" alt=""
                                srcset="">
                        </td>
                    </tr>
                    <?php $i++; ?>
