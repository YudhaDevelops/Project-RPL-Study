        ...
        <page_header>
            ...
            <table class="page_header">
                <tr>
                    ...
                    <td style="text-align: center; width: 60%">LAPORAN DATA CUSTOMER</td>
        ...
        <table class="tabel2">
            <thead>
                <tr>
                    ...
                    <td style="text-align: center; background: #ddd"><b>Nama Customer</b></td>
                    <td style="text-align: center; background: #ddd"><b>Nomor HP</b></td>
                    <td style="text-align: center; background: #ddd"><b>Email</b></td>
                    <td style="text-align: center; background: #ddd"><b>Jenis Kelamin</b></td>
                    <td style="text-align: center; background: #ddd"><b>Nama Hewan</b></td>
                    <td style="text-align: center; background: #ddd"><b>Umur Hewan / Thn</b></td>
                    <td style="text-align: center; background: #ddd"><b>Tipe Hewan</b></td>
                    <td style="text-align: center; background: #ddd"><b>Alamat</b></td>
                    <td style="text-align: center; background: #ddd"><b>Gambar Hewan</b></td>
                </tr>
            </thead>
            <tbody>
                <?php $i = 1; ?>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td style="text-align: center; width:90px;">
                            <img src="{{ $item->gambar_hewan }}" style="max-width: 90px;" alt=""
                                srcset="">
                        </td>
                    </tr>
                    <?php $i++; ?>
