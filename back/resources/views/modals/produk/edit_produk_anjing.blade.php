@if ($data != null)
    @foreach ($data as $modalUpdate)
        <div class="modal fade bs-example-modal-lg modal_update_inti" data-id="#edit_modal_produk_anjing_{{ $modalUpdate->id }}" id="edit_modal_produk_anjing_{{ $modalUpdate->id }}" tabindex="-1"
            role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">Edit Data Produk Anjing</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <form action="{{ route('anjing.update', ['id' => $modalUpdate->id]) }}" method="POST"
                        id="form_edit_anjing" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group  @error('nama_produk') has-danger @enderror">
                                        ...
                                        <input value="{{ $modalUpdate->nama_produk }}" type="text" name="nama_produk"
                                            id="nama_produk"
                                            class="form-control 
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group @error('harga') has-danger @enderror ">
                                        ...
                                        <input value="{{ $modalUpdate->harga }}" type="number" name="harga"
                                            id="harga"
                                            class="form-control
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group @error('bobot')) has-danger @enderror ">
                                        ...
                                        <input value="{{ $modalUpdate->bobot }}" type="number" name="bobot"
                                            id="bobot"
                                            class="form-control
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group @error('stok')) has-danger @enderror">
                                        ...
                                        <input value="{{ $modalUpdate->stok }}" id="stok" type="text"
                                            value="0" name="stok"
                                            class="form-control
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <img alt="" width="100px"
                                            src="@if ($modalUpdate->gambar_produk != null) {{ $modalUpdate->gambar_produk }} @endif"
                                            id="view_image_edit_modal">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group @error('gambar_produk_update')) has-danger @enderror">
                                        <label for="gambar_produk_update">Gambar Produk</label>
                                        <input type="file" name="gambar_produk_update" id="gambar_produk_update"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
