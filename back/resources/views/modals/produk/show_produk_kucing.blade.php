@if ($data != null)
    @foreach ($data as $modalData)
        <div class="modal fade bs-example-modal-lg" id="show_modal_produk_kucing_{{$modalData->id_produk}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">Show Data Produk Kucing</h4>
