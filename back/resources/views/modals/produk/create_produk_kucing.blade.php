<div class="modal fade bs-example-modal-lg" id="create_modal_produk_kucing" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('kucing.simpan')}}" method="POST" id="form_create_kucing" enctype="multipart/form-data">
                @csrf
