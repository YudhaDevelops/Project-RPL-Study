<div class="modal fade bs-example-modal-lg" id="create_modal_jasa_penitipan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Add New Produk Kucing</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <form action="{{route('jasa.save.penitipan')}}" method="POST" id="form_create_kucing" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="button submit" class="btn btn-primary" id="simpan">Save</button>
                </div>
            </form>
        </div>
    </div>
