@extends('layouts.master', ['laporan_penjualan' => 'active', 'title' => 'Laporan Penjualan | '])
@section('head')
@stop
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Halaman Laporan Penjualan</h4>
                            </div>
                        ...
                        <div class="pd-20">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <h2 class="text-black">Cari Laporan Penjualan</h2>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                ...
                                <div class="dropdown-menu">
                                    <form action="{{route('exportPDFTransaksiProduk')}}" target="_blank" method="get">
                                    ...
                                    <form action="{{route('exportTransaksiProduk')}}" target="_blank" method="get">
                                    ...
                                    @if (isset($laporan) && $laporan != null)
                                        ...
                                        @foreach ($laporan as $p)
                                            <tr>
                                                ...
                                                <td>{{ date('d-M-Y', strtotime($p->tanggal_transaksi_produk)) }}</td>
                                                <td>@currency($p->total_harga_produk)</td>
